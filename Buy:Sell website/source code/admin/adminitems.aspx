<%@ Page Language="C#" AutoEventWireup="true" CodeFile="adminitems.aspx.cs" Inherits="admin_adminitems" %>
                     ...
                     <ItemTemplate>
                      <div class="col-md-4">
                          ...
                          <div class="col-md-8 pad2 lead">
                           ...
                           <asp:HyperLink ID="itemhyperlink" runat="server" NavigateUrl='<%#"adminedititems.aspx?itemid="+ Eval("ID")%>'>
                         <div class="imgright">
