<%@ Page Language="C#" AutoEventWireup="true" CodeFile="buyersignup.aspx.cs" Inherits="buyersignup" %>
            ...
            <div class="row">
                <div class="col-xs-12">                   
                    <div class="intro-text">
                        <span class="name">Create a Buyer Account</span>
                        <hr class="star-light">
        ...
        <div class="container">
            <div class="row">
                <span class="form-group">
                    <!--<asp:SqlDataSource ID="dropdownsrc" runat="server" ConnectionString='<%$ConnectionStrings:connect%>' SelectCommand="SELECT * FROM [elmtreeusers]"></asp:SqlDataSource>-->
              <!-- First Name -->
                <div class="form-group"> 
					 <label for="nbame" class="col-sm-2 control-label">First Name: </label>
					 <div class="col-sm-6">
                  ...
                  <br />
					...
					<div class="form-group"> 
                        ...
                        <div class="col-sm-6">
						<asp:TextBox ID="phonen" CssClass="form-control" runat="server"></asp:TextBox>
						</div>
					</div>
                    <br />
                    <br />
					...
					<div class="form-group"> 
                        ...
                        <div class="col-sm-6">
						<asp:TextBox ID="pword" CssClass="form-control" runat="server"></asp:TextBox>
						</div>
					</div>
                    <br />
                    <br />
                    ...
                    <div class="form-group"> 
                        ...
                        <div class="col-sm-6">
						<asp:TextBox ID="learning" CssClass="form-control" runat="server"></asp:TextBox>
						</div>
                        ...
                        <br />
                        <br />
                    <asp:Button CssClass="btn btn-primary btn-lg" ID="uploadbutton" role="button" runat="server" Text="Create Account" OnClick="uploadbutton_Click" />
                       </div>
                         <br/>
