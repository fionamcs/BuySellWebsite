    ...
    <section id="portfolio">
        <div class="container">
            <div class="row">
                ...
                <p><a class="btn btn-success" href="signin.aspx" role="button">Sign In &raquo;</a></p>
                </div>
                </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    ...
                    <p>Shop out items for sale by clicking the button below.</p>
                    <p><a class="btn btn-success" href="shop.aspx" role="button">Shop Now &raquo;</a></p>
                </div>
                </div>
            </div>
        </div>
