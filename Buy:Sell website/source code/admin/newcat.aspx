<%@ Page Language="C#" AutoEventWireup="true" CodeFile="newcat.aspx.cs" Inherits="admin_newcat" %>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="form-group"> 
					 ...
					 <div class="col-sm-6">
                    <asp:TextBox ID="catname" CssClass="form-control" runat="server">
                    </asp:TextBox>
					</div>
				</div>
                  <br />
                  <br />
					...
					<div class="form-group"> 
                        ...
                        <asp:Button CssClass="btn btn-primary btn-lg" ID="uploadbutton" role="button" runat="server" Text="Add Category" OnClick="uploadbutton_Click" />
