...
public partial class admin_admineditbuyer : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            string buyer = Request.QueryString["buyerid"].ToString();
            //select info where id is the same as session
            string query = "SELECT * FROM [elmtreebuyer] WHERE buyerID=@buyerid";
            ...
            com.Parameters.AddWithValue("@buyerid", buyer);
    ...
    protected void updatebutton_Click(Object sender, EventArgs e)
    {
        ...
        string query = "UPDATE elmtreebuyer SET firstname = @firstname, lastname = @lastname, username=@username, address = @address, phoneno=@phone, learningin=@learning, password=@password, email=@email, pic=@pic WHERE buyerID=@buyerid";
        ...
        Response.Redirect("adminbuyers.aspx");
    }
