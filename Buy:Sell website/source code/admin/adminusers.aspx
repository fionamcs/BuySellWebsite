<%@ Page Language="C#" AutoEventWireup="true" CodeFile="adminusers.aspx.cs" Inherits="admin_adminusers" %>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    ...
                    <p><a class="btn btn-success" href="adminsellers.aspx" role="button">Sellers &raquo;</a></p>
                    <p><a class="btn btn-success" href="adminbuyers.aspx" role="button">Buyers &raquo;</a></p>
                </div>
                </div>
            </div>
    </section>
