<%@ Page Language="C#" AutoEventWireup="true" CodeFile="buyercategory.aspx.cs" Inherits="admin_buyer_buyercategory" %>
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="page-scroll">
                        <a href="buyerhomepage.aspx">Buyer Homepage</a>
                    </li>
                    <li class="page-scroll">
                    ...
                    <asp:ListView ID="displaygenre" runat="server" DataSourceID="genreresult">
                        ...
                        <ItemTemplate>
                            ...
                            <asp:HyperLink ID="HyperLink1" runat="server"
                                 NavigateUrl='<%# "buyeritem.aspx?itemid="+ Eval("ID") %>' >
