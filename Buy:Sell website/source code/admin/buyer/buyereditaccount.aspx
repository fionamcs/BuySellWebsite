<%@ Page Language="C#" AutoEventWireup="true" CodeFile="buyereditaccount.aspx.cs" Inherits="admin_buyer_buyereditaccount" %>
                  ...
                  <br />
                    ...
                    <div class="form-group"> 
                        ...
                        <div class="form-group">
                            ...
                            <asp:Image ID="imageupdate" runat="server" /> 
                             </div>
				        </div>
                        <br />
                        <br />
                    <asp:Button CssClass="btn btn-primary btn-lg" ID="updatebutton" role="button" runat="server" Text="Update Account" OnClick="upbutton_Click" />
                       </div>
                         <br/>
