<%@ Page Language="C#" AutoEventWireup="true" CodeFile="seller.aspx.cs" Inherits="admin_buyer_seller" %>
...
<body>
    ...
    <!-- Portfolio Grid Section -->
     ...
     <asp:SqlDataSource ID="showitem" runat="server" 
         ...
         SelectCommand="SELECT elmtreeseller.ID, elmtreeseller.username, elmtreeseller.firstname, elmtreeseller.lastname, items.sellerID 
         FROM elmtreeseller
         INNER JOIN items ON items.sellerID = elmtreeseller.ID 
         WHERE (items.sellerID = elmtreeseller.ID)">
         <SelectParameters>
