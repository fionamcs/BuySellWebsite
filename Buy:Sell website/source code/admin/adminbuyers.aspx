<%@ Page Language="C#" AutoEventWireup="true" CodeFile="adminbuyers.aspx.cs" Inherits="admin_adminbuyers" %>
        ...
        <div class="container">
            <div class="row">
                 <div class="col-lg-12 text-center">
                    <h2>Admin Buyers Access</h2>
                
                     <h3>Click on the images to edit Buyers </h3>
                    
                      <div class="col-md-4">
                            <div class="container">
	   
            <asp:SqlDataSource ID="buyers" runat="server" 
            ConnectionString="<%$ ConnectionStrings:connect %>" 
                SelectCommand="SELECT * FROM elmtreebuyer">
            
            </asp:SqlDataSource>
                 <asp:ListView ID="listofbuyers" runat="server" DataSourceID="buyers">
                     ...
                     <ItemTemplate>
                      <div class="col-md-4">
                          ...
                          <div class="col-md-8 pad2 lead">
                           ...
                           <asp:HyperLink ID="itemhyperlink" runat="server" NavigateUrl='<%#"admineditbuyer.aspx?buyerid="+ Eval("buyerID")%>'>
                         <div class="imgright">
