<%@ Page Language="C#" AutoEventWireup="true" CodeFile="edititem.aspx.cs" Inherits="admin_seller_edititem" %>
            ...
            <div class="row">
                <div class="col-xs-12">                   
                    <div class="intro-text">
                        <span class="name">Edit Item</span>
                        <hr class="star-light">
                ...
                <div class="form-group"> 
                  ...
                  <br />
					...
					<div class="form-group"> 
                        ...
                        <br />
                        <br />
                    <asp:Button CssClass="btn btn-primary btn-lg" ID="updatebutton" role="button" runat="server" Text="Update Image" OnClick="updatebutton_Click" />
                       </div>
                         <br/>
