<%@ Page Language="C#" AutoEventWireup="true" CodeFile="admineditcat.aspx.cs" Inherits="admin_admineditcat" %>
            ...
            <div class="row">
                <div class="col-xs-12">                   
                    <div class="intro-text">
                        <span class="name">Admin Edit Category</span>
                        <hr class="star-light">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="form-group"> 
					 ...
					 <div class="col-sm-6">
                    <asp:TextBox ID="category" CssClass="form-control" runat="server">
                    </asp:TextBox>
					</div>
				</div>
                  <br />
                ...
                <div class="form-group"> 
					 ...
					 <div class="col-sm-6">
                    <asp:TextBox ID="description" CssClass="form-control" runat="server">
                    </asp:TextBox>
					</div>
				</div>
                  <br />
